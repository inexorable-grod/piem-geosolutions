      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="section-reveal text-center mb-16">
          ...
          <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl font-bold text-[var(--text)] mb-4">
            Software In-House &amp;{' '}
            <span className="text-gradient-orange">Technology Partnerships</span>
          </h2>
        ...
        <div className="section-reveal grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
          {TECH_PARTNERS.map((tech, i) => (
            <div
              key={i}
              className="group p-5 rounded-xl border border-[var(--border)] bg-[var(--card)] hover:border-orange-400/40 hover:shadow-orange transition-all duration-300 text-center"
            >
              ...
              <h3 className="font-display text-base font-semibold text-[var(--text)] group-hover:text-orange-400 transition-colors mb-1">
                {tech.name}
              </h3>
